...
navList =
    [ li [ class "nav-item" ]
        ...
        , li [ class "nav-item services-dropdown" ]
            [ a [ class "nav-link services-dropdown-toggle", href (Route.toHref Route.WebsiteRecovery) ]
                [ text "Services "
                , span [ style "font-size" "10px", style "vertical-align" "middle" ] [ text "▾" ]
                ]
            , ul [ class "services-dropdown-menu" ]
                [ li []
                    [ a [ href (Route.toHref Route.WebsiteRecovery) ]
                        [ text "Website Recovery" ]
                    ]
                , li []
                    [ a [ href (Route.toHref Route.ExpiredDomainRecovery) ]
                        [ text "Expired Domain Recovery" ]
                    ]
                , li []
                    [ a [ href (Route.toHref Route.PbnRestoration) ]
                        [ text "PBN Restoration" ]
                    ]
                ]
            ]
        , li [ class "nav-item" ]
